...
## Now
- v0.1.0 — Project skeleton: upload portal, Supabase DB + storage wired, submissions stored on upload.
- v0.2.0 — Parsing agent: extract structured text from both PDF (PyMuPDF) and PPTX (python-pptx).
